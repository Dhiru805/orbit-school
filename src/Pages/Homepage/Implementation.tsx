import { CheckCircle2, Clipboard, Wrench, Rocket, Users, BarChart } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      description: 'Comprehensive evaluation of your school needs, infrastructure, and goals',
      duration: 'Week 1',
    ...
    },
    {
      ...
      description: 'Tailored solution design based on your budget, student count, and requirements',
      duration: 'Week 2',
    ...
    },
    {
      ...
      description: 'Installation of smart classes, labs, hardware, and software systems',
      duration: 'Week 3-4',
    ...
    },
    {
      ...
      description: 'Comprehensive training programs for staff on all new systems and technologies',
      duration: 'Week 5',
    ...
    },
    {
      icon: Rocket,
      title: 'Go Live',
      description: 'Official launch with full support, monitoring, and troubleshooting',
      duration: 'Week 6',
    ...
    },
    {
      ...
      description: '24/7 support, regular updates, maintenance, and performance optimization',
      duration: 'Ongoing',
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-block px-4 py-2 bg-blue-600 text-white rounded-full mb-4">
            <span className="font-semibold text-sm">Implementation Process</span>
          </div>
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            From <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-yellow-600">Vision to Reality</span> in 6 Weeks
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our proven implementation process ensures a smooth, hassle-free transformation with minimal disruption.
          </p>
        </div>
                  ...
                  <div className="inline-block">
                    <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                      ...
                      <div className="inline-block px-4 py-2 bg-blue-50 rounded-full">
                        <span className="text-blue-700 font-semibold text-sm">{step.duration}</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative z-10">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <h4 className="text-2xl font-bold text-white mb-2">Zero Downtime</h4>
                <p className="text-blue-100">Implementation happens alongside regular school operations</p>
              </div>
              <div>
                <CheckCircle2 className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                <h4 className="text-2xl font-bold text-white mb-2">Full Training</h4>
                <p className="text-blue-100">Every staff member fully trained and confident before launch</p>
              </div>
              <div>
                <CheckCircle2 className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                <h4 className="text-2xl font-bold text-white mb-2">24/7 Support</h4>
                <p className="text-blue-100">Dedicated support team available round the clock</p>
              </div>
            </div>

            <div className="mt-12 text-center">
              <h3 className="text-3xl font-bold text-white mb-4">Ready to Transform Your School?</h3>
              <p className="text-xl text-blue-100 mb-8">Let's discuss your implementation timeline</p>
