  ...
  const stories = [
    {
      ...
      metrics: [
        ...
        { label: "Revenue Increase", value: "₹1.5 Cr", icon: Award },
        { label: "Parent Rating", value: "4.9/5", icon: Star },
        { label: "Teacher Satisfaction", value: "99%", icon: Star },
      ],
      quote:
    ...
    // {
    //   school: 'Bright Future International',
    //   location: 'Indore, Madhya Pradesh',
    //   metrics: [
    //     { label: 'Admission Growth', value: '+28%', icon: TrendingUp },
    //     { label: 'New Students', value: '+850', icon: Users },
    //     { label: 'Revenue Increase', value: '₹1.8 Cr', icon: Award },
    //     { label: 'Teacher Satisfaction', value: '96%', icon: Star },
    //   ],
    //   quote: 'The comprehensive ERP system saved us over ₹80 lakhs compared to setting up everything independently. Fee collection improved from 72% to 98%, and our teachers are more productive than ever.',
    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gradient-to-r from-blue-900 to-blue-800 rounded-2xl px-8 py-6 shadow-xl">
